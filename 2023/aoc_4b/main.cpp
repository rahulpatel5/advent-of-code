...
int main()
{
    ...
    constexpr std::string_view testInput {R"(Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53
...
Card 6: 31 18 13 56 72 | 74 77 10 23 35 67 36 11
    ...
    // aoc4b::Cards cards {aoc4b::getTotalWinningCards<testLength>(testLines)};
    aoc4b::Cards cards {aoc4b::getTotalWinningCards<length>(lines)};
    std::cout << "Number of scratchcards is: " << cards << '\n';
