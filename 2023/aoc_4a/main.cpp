...
Card 6: 31 18 13 56 72 | 74 77 10 23 35 67 36 11
    ...
    // aoc4a::Points points {aoc4a::getTotalWinningPoints<testLength>(testLines)};
    aoc4a::Points points {aoc4a::getTotalWinningPoints<length>(lines)};
    std::cout << "Number of points is: " << points << '\n';
