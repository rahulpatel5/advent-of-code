...
int main()
{
    ...
    constexpr std::string_view testInput {R"(seeds: 79 14 55 13
...
56 93 4
    ...
    // aoc5a::SeedInt lowest {aoc5a::getLowestLocationNumber<testLength>(testLines)};
    aoc5a::SeedInt lowest {aoc5a::getLowestLocationNumber<length>(lines)};
    std::cout << "Lowest location number is: " << lowest << '\n';
