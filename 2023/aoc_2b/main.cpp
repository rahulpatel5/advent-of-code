...
int main()
{
    ...
    constexpr std::string_view testInput {R"(Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green
    ...
    // aoc2b::IdInt sum {aoc2b::getSumOfPowers<testLength>(testLines)};
    aoc2b::IdInt sum {aoc2b::getSumOfPowers<length>(lines)};
    std::cout << "Sum of game IDs is: " << sum << '\n';
