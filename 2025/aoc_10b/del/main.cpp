...
int main()
{
    ...
    constexpr std::string_view testInput {R"([.##.] (3) (1,3) (2) (2,3) (0,2) (0,1) {3,5,4,7}
...
[.###.#] (0,1,2,3,4) (0,3,4) (0,1,2,4,5) (1,2) {10,11,11,5,10,5}
    ...
    aoc10b::PressInt presses { aoc10b::getFewestPresses<testLength>(testLines) };
    // aoc10b::PressInt presses { aoc10b::getFewestPresses<length>(lines) };
    std::cout << "fewest presses: " << presses << '\n';
