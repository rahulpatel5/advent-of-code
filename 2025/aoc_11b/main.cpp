...
int main()
{
    ...
    constexpr std::string_view testInput {R"(svr: aaa bbb
aaa: fft
fft: ccc
bbb: tty
tty: ccc
...
hhh: out
    ...
    // aoc11b::PathInt paths { aoc11b::countPaths<testLength>(testLines) };
    aoc11b::PathInt paths { aoc11b::countPaths<length>(lines) };
    std::cout << "visited paths: " << paths << '\n';
