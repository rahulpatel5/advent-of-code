...
2024
    ...
    constexpr size_t iterations {2'000};
    constexpr int sequenceSize {4};
    aoc22b::BananaInt bananas {aoc22b::parseAndGetBananas<length, iterations, sequenceSize>(lines)};
    std::cout << "most number of bananas: " << bananas << '\n';
