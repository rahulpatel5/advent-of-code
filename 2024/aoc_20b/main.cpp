...
###############
    ...
    constexpr int testTarget {50};

    constexpr int maxCheat {20}; // 20 steps is max
    int saved {aoc20b::parseAndCountSavingCheats<length, target, maxCheat>(lines)};
    std::cout << "cheats saving at least the target time: " << saved << '\n';
