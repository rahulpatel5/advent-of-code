...
int main()
{
    ...
    constexpr std::string_view testInput {R"(47|53
97|13
97|61
97|47
75|29
...
97,13,75,29,47
    ...
    int sum {aoc5b::parseAndSumMiddlePages<length>(lines)};
    std::cout << "The sum of middle pages is: " << sum << '\n';
