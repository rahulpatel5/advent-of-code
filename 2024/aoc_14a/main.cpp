...
int main()
{
    ...
    constexpr std::pair<int, int> map {101, 103};
...
p=9,5 v=-3,-3
    ...
    constexpr std::pair<int, int> testMap {11, 7};
    
    constexpr int time {100}; // 100 seconds for the puzzle
    int safety {aoc14a::parseAndGetSafetyFactor<length, time>(lines, map)};
